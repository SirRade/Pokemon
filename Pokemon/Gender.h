...
enum class Gender {
    ...
    Autigender, // (POSSIBLE TRIGGER WARNING) a gender that can only be understood in the context of being autistic
    ...
    GenderNeutral, // the feeling of having a neutral gender, whether somewhere in between masculine and feminine or a third gender that is separate from the binary; often paired with neutrois
